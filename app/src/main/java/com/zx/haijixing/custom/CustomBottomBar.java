...
public class CustomBottomBar extends View {
    ...
    private int titleColorBefore = Color.parseColor("#989898");
    private int titleColorAfter = Color.parseColor("#f77817");
    ...
    public CustomBottomBar setContainer(int containerId) {
        this.containerId = containerId;
        return this;
    }

    public CustomBottomBar setTitleBeforeAndAfterColor(String beforeResCode, String AfterResCode) {//支持"#333333"这种形式
        this.titleColorBefore = Color.parseColor(beforeResCode);
        this.titleColorAfter = Color.parseColor(AfterResCode);
        return this;
    }

    public CustomBottomBar setTitleSize(int titleSizeInDp) {
        this.titleSizeInDp = titleSizeInDp;
        return this;
    }

    public CustomBottomBar setIconWidth(int iconWidth) {
        this.iconWidth = iconWidth;
        return this;
    }

    public CustomBottomBar setTitleIconMargin(int titleIconMargin) {
        this.titleIconMargin = titleIconMargin;
        return this;
    }

    public CustomBottomBar setIconHeight(int iconHeight) {
        this.iconHeight = iconHeight;
        return this;
    }

    public CustomBottomBar addItem(Class fragmentClass, String title, int iconResBefore, int iconResAfter) {
    ...
    public CustomBottomBar setFirstChecked(int firstCheckedIndex) {//从0开始
    ...
    private void initParam() {
        if (itemCount != 0) {
            ...
            Log.i("BOY","<><><>"+iconWidth+"<><>"+iconHeight);
            //图标文字margin
