...
public class PrintAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (printEntry != null){
            if (getItemViewType(i) == HEAD_ITEM){
                ...
                printHeadViewHolder.start.setText(printEntry.getLineStartName());
                printHeadViewHolder.end.setText(printEntry.getLineEndName());
                ...
                printViewHolder.end.setText(printEntry.getLineEndName());
    ...
    class PrintHeadViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView select ;
        TextView start,end,orderNum,sendMan,sendLocate,receiveMan,receiveLocate,freight,type,number,detail;
        public PrintHeadViewHolder(@NonNull View itemView) {
            ...
            sendLocate = itemView.findViewById(R.id.print_header_send_locate);
            receiveMan = itemView.findViewById(R.id.print_header_receive_man);
            receiveLocate = itemView.findViewById(R.id.print_header_receive_locate);
            freight = itemView.findViewById(R.id.print_header_freight);
            type = itemView.findViewById(R.id.print_header_type);
            number = itemView.findViewById(R.id.print_header_number);
            detail = itemView.findViewById(R.id.print_header_total_detail);
        }
    }
    ...
    public interface TotalPrintListener{
        void totalResult(int total,int head);
    }
}
